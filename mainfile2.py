...
X =np.array(data[['Projectmanagementmethodologies',  'Changemanagementprocess', 
    'Sitelimitationandlocation','Technologicalenvironment',  'Formaldisputeresolutionprocess',
     'Contractmanagementandperformance',  'Projectteamcommitment',
    'QualityAssurance', 'ProjectInitialPlanning', 'Levelofautomation', 
    'Consultantcompetence',  'Projectteammotivation', 'Politicalenvironment', 
    'Functionalrequirements', 'Userclientsatisfaction', 'TopManagementsupport',
    'QualityofaConstructionProject',  'ConstructionCost',  'Completiontime', 
    'Clientfinancialcapacity',  'Projecttechnicalteamexperienceandcompetence', 
    'ProjectManagercompetence']])
...
st.write(pd.DataFrame({
  'Result': ["Not Likely to Succeed","Highly Likely to Succeed"]}))
...
X = data[['Projectmanagementmethodologies',  'Changemanagementprocess', 
    'Sitelimitationandlocation','Technologicalenvironment',  'Formaldisputeresolutionprocess',
     'Contractmanagementandperformance',  'Projectteamcommitment',
    'QualityAssurance', 'ProjectInitialPlanning', 'Levelofautomation', 
    'Consultantcompetence',  'Projectteammotivation', 'Politicalenvironment', 
